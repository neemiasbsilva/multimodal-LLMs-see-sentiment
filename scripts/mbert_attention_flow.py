...
from models.model import ModernBERTModel
...
LABEL_NAMES = {
    "p5":     ["Negative", "Slightly negative", "Neutral", "Slightly positive", "Positive"],
    "p3":     ["Neutral", "Negative", "Positive"],
    "p2plus": ["Not positive", "Positive"],
    "p2neg":  ["Not negative", "Negative"],
...
def parse_args():
    ...
    parser.add_argument("--reports_dir", default="reports/attention_flow")
